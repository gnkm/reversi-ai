...
総当たりを取り直すときは、いまの `round-robin.json` を `archive/2026-09-20-1712.json` のような名前でコピーしてから置き換え、上のコマンドで本ファイルと `round-robin.md` を書き直す。
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [2026-09-20 17:12](round-robin.json) | 5.5 | 7 | 9.5 | 18 | 11.5 | 5.5 | 4.5 | 9.5 | 5 | 14 |
...
| 記録 | 一様 | 最多 | 位置 | ミニ | 定石 | ML | LGBM | RL | NN | Jev |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [2026-09-20 17:12](round-robin.json) | 8 | 6 | 5 | 1 | 3 | 7 | 10 | 4 | 9 | 2 |
...
横軸は古い順の世代（通し番号。時刻は上の表）。縦軸は順位。1 が上、11 がランク外。カタログに無い世代は最下位より下のランク外として描く。点と点は直線で結ぶ。線の色は個体ごとで、終端に略称を置く。凡例は出さない。
...
config:
    ...
    themeVariables:
        xyChart:
            plotColorPalette: '#0077BB, #D62728, #009988, #FF7F0E, #9467BD, #8C564B, #E377C2, #17BECF, #2CA02C, #6A3D9A'
---
xychart-beta
    title "総当たりの順位"
    x-axis [1, 2, 3, 4, " ", " "]
    y-axis "順位（11=ランク外）" 11 --> 1
    line "一様" [9, 6, 10, 8 "一様"]
    line "最多" [3, 5, 6, 6 "最多"]
    line "位置" [5, 4, 4, 5 "位置"]
    line "ミニ" [1, 1, 1, 1 "ミニ"]
    line "定石" [2, 2, 2, 3 "定石"]
    line "ML" [6, 7, 7, 7 "ML"]
    line "LGBM" [11, 8, 9, 10 "LGBM"]
    line "RL" [4, 3, 3, 4 "RL"]
    line "NN" [8, 9, 8, 9 "NN"]
    line "Jev" [7, 10, 5, 2 "Jev"]
```
