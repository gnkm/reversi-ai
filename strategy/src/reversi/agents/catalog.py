...
LGBM = CatalogItem(
    specimen_id=lgbm.SPECIMEN_ID,
    category=lgbm.CATEGORY,
    display_name=lgbm.DISPLAY_NAME,
    description=lgbm.DESCRIPTION,
)
RL = CatalogItem(
...
_BUILTIN: tuple[tuple[CatalogItem, Chooser], ...] = (
    ...
    (RL_PATTERN, rl_pattern.choose_move),
    (NN, nn.choose_move),
    (JEV, jev.choose_move),
)
